...
Spoken pitch. ~90 seconds. Read it out loud.
...
Live on Portaldot mainnet. I grab a starter prompt: "overview my account." Connect SubWallet. There's my balance counting up. My identicon, my QR.

Now: "send one POT to five-grw…" A preview card pops up — my face, the recipient's face, the amount. I sign. A "PAID" stamp lands the second the block confirms. Real chain. Real money. Real receipt.

## Where

`portaldot-mcp.vercel.app`. Open source on GitHub. Built for the Portaldot Mini Hackathon.
